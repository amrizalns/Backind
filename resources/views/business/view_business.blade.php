          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <label style="font-size:small" >
                <textarea rows="7" cols="100"style="font-size: small" id="desc" type="text" class="form-control" name="desc" disabled>{{$business_details->business_desc}}</textarea>
              </label>
            </div>
          </div>
        </div>
      ...
      <div class="form-group col-lg-12" style="background-color:#fafafa; border-radius:10px; border:0px">
        <div class="row">
          ...
          <div class="col-lg-12" style="margin-top:15px; margin-bottom:15px">
            <label style="font-size:small">Detail Gambar Usaha</label>
            <hr>
            <div class="row">
              <div class="col-md-8">
              ...
              <tbody>
                @foreach ($booking_data as $i =>$key)
                  <tr>
                    ...
                    <td>{{$key->name}}</td>
                    @if ($key->id_tourism!=null)
                        <td>{{$key->checkin_tourism}}</td>
                    @else
                        <td>{{$key->checkin}}</td>
                    @endif
